...
})({"cucIK":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Inicialització del plugin feather
    feather.replace();
});

},{"./theme.js":"bTBbp"}],"bTBbp":[function(require,module,exports) {
/**
...
function setTheme(theme, save) {
    ...
    const selectedTheme = theme === "osdefault" ? window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light" : theme;
    html.dataset.theme = selectedTheme;
    if (save) localStorage.setItem("ring-theme", selectedTheme);
}
/**
...
},{}]},["cucIK","l17dj"], "l17dj", "parcelRequirea87c")
